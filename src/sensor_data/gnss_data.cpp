...
//静态成员变量必须在类外初始化
double my_lidar_localization::GNSSData::origin_longitude = 0.0;
double my_lidar_localization::GNSSData::origin_latitude = 0.0;
double my_lidar_localization::GNSSData::origin_altitude = 0.0;
